      ...
      <Page size="A4" style={styles.page}>
        ...
        <View style={styles.card}>
          ...
          <View style={styles.resultRow}>
            ...
            <View style={styles.statBox}>
              <Text style={styles.statLabel}>AI Prediction</Text>
          ...
          <Text style={styles.aiDesc}>
            {safeResult.peringatan ? `Warning: ${safeResult.peringatan}\n` : ''}
            Based on the AI assessment with a confidence of {confidence}, your condition indicates {riskStyle.label.toLowerCase()}.
            {safeResult.recommendation ? ` ${safeResult.recommendation}` : ''}
          </Text>
        ...
        <View style={styles.footer} fixed>
          <Text style={styles.footerText}>
            GastroCare AI Assessment • Generated on {currentDate}
          </Text>
          <Text style={styles.footerText}>
            Disclaimer: This report is generated by an AI model for informational purposes only. It is not a substitute for professional medical advice, diagnosis, or treatment. Always consult with a qualified healthcare provider.
          </Text>
        </View>
      </Page>
    </Document>
